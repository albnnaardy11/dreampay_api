...
<Heading
  ...
  children={"DreamPay API"}
>
</Heading>



High-integrity financial API for Santri Market Day ecosystem. Built with Laravel and secured with Sanctum.
...
>
  ...
  >
    ...
    DreamPay Team: [admin@dreampay.id](mailto:admin@dreampay.id)
  </span>
</div>
